...
import { Stats } from "./diamond/stats.js";
import {
    MeshBVH,
    MeshBVHVisualizer,
...
async function main() {
    ...
    // Lighting
    const ambientLight = new THREE.AmbientLight(0x404040); // Change here
    ...
    // Objects
    let diamondGeo = (await AssetManager.loadGLTFAsync("diamond/diamond.glb")).scene.children[0].children[0].children[0].children[0].children[0].geometry;
